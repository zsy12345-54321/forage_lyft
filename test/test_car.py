...
class TestCalliope(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car_C = CarFactory.create_calliope(today,last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car_C.needs_service())
    ...
    def test_battery_should_not_be_serviced(self):
        ...
        car_C = CarFactory.create_calliope(today, last_service_date, current_mileage, last_service_mileage)
        self.assertFalse(car_C.needs_service())
